...
Leung (2020) to compute the Bayesian
posterior
...
Bayesian posterior probabilities. The
model with the direct path `x3~x1` added
has substantially large Bayesian posterior
...
We then examine the Bayesian posterior
probabilities:
